...
class SimpleBackgroundMusicAdder:
    def __init__(self):
    ...
    def create_simple_background_music(self):
        ...
        cmd = [
            "ffmpeg", "-y",
            "-f", "lavfi",
            "-i", "sine=frequency=220:duration=180",  # 3분간 A3 톤 (더 낮은 톤)
            "-af", "volume=0.1",  # 볼륨 낮춤
            bg_music_path
        ]
...
def main():
    print("🎵 maro 채널 간단한 배경음악 추가 시작")
    print("=" * 60)
    
    adder = SimpleBackgroundMusicAdder()
